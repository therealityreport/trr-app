...
describe("season tab alias redirect route", () => {
  ...
  it("normalizes legacy details alias to overview", async () => {
    ...
    await expect(
      ...
      "REDIRECT:/admin/trr-shows/7f528757-5017-4599-8252-c02f0d0736cf/seasons/6",
    );
  });
  ...
  it("accepts and preserves overview tab alias", async () => {
    ...
    await expect(
      ...
      "REDIRECT:/admin/trr-shows/7f528757-5017-4599-8252-c02f0d0736cf/seasons/6?source_scope=community",
    );
  });
});
