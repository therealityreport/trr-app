  ...
  return (
    <>
      <header className="border-b border-black bg-white text-black">
        <div className="relative flex h-20 items-center justify-center border-b border-black px-4">
          <button
            type="button"
            ...
            className="absolute left-4 rounded-full p-2 text-black transition hover:bg-black/[0.04]"
          >
          ...
          <div className="absolute right-4 flex items-center gap-2">
            ...
            <HealthIndicator
              ...
              className="group relative flex items-center gap-1.5 rounded-full border border-black px-2.5 py-1.5 text-black transition hover:bg-black/[0.04]"
            />
          </div>
        </div>
        ...
        {children ? (
          <div
            ...
            style={{ color: ACCENT }}
            {...buildTypographyDataAttributes({ area: "admin", role: "headerMeta" })}
          >
            {children}
          </div>
        ) : null}
