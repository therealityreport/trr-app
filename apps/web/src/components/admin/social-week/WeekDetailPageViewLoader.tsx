...
function WeekDetailPageViewLoadingSkeleton() {
  return (
...
const WeekDetailPageView = dynamic(
  () => import("@/components/admin/social-week/WeekDetailPageView"),
  {
    loading: () => <WeekDetailPageViewLoadingSkeleton />,
    ssr: false,
  },
);
