      ...
      >
        ...
        >
          <Button
            ...
            size="sm"
            type="button"
            className="size-7 min-h-0 p-0 text-muted-foreground hover:text-foreground"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  size="sm"
                  type="button"
                  className="size-6 min-h-0 p-0 opacity-0 transition-opacity group-hover:opacity-100 focus:opacity-100"
