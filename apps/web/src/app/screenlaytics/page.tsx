...
const breadcrumbs = buildAdminSectionBreadcrumb("Screenalytics", "/screenlaytics");
const MIN_QUERY_LENGTH = 2;

export default function ScreenlayticsPickerPage() {
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600">
            Pick a show, then jump into its admin workspace for screen-time and related review flows.
          </p>
        </div>
          ...
          <div className="overflow-hidden rounded-[28px] border border-zinc-200 bg-white shadow-sm">
            <div className="border-b border-zinc-200 bg-[radial-gradient(circle_at_top_left,_rgba(24,24,27,0.06),_transparent_48%),linear-gradient(135deg,_#fafafa,_#f4f4f5)] px-6 py-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <div className="rounded-2xl border border-zinc-200 bg-white/80 px-4 py-3 text-right shadow-sm">
                  ...
                  <div className="mt-1 text-sm font-medium text-zinc-900">/admin/&lt;show&gt;</div>
                </div>
              </div>
            ...
            <div className="grid gap-4 p-5 md:grid-cols-2">
              ...
              {results.map((show) => {
                ...
                const href = `/admin/${encodeURIComponent(routeSlug)}` as Route;
                return (
                  <Link
                    key={show.id}
                    href={href}
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <p className="mt-2 break-all text-xs text-zinc-500">admin/{routeSlug}</p>
                      </div>
