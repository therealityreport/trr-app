...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const backendUrl = getBackendApiUrl(`/admin/shows/${showId}/seasons/${seasonNumber}/import-fandom/commit`);
    if (!backendUrl) {
    ...
    console.error("[api] Failed to commit season fandom import", error);
