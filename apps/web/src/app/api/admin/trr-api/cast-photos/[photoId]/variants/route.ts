 ...
 *
 * Proxy to TRR-Backend variants endpoint for cast photos.
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const backendUrl = getBackendApiUrl(`/admin/cast-photos/${photoId}/variants`);
    if (!backendUrl) {
    ...
    console.error("[api] Failed to generate cast photo variants", error);
