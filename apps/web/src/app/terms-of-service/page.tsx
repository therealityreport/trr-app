  ...
  return (
    <div className="w-[1440px] h-[900px] relative bg-white mx-auto">
      ...
      <div className="w-[800px] left-[320px] top-[120px] absolute">
        <h1 className="text-3xl font-['Gloucester_OS_MT_Std'] mb-8">Terms of Service</h1>
        <p className="font-['HamburgSerial'] text-gray-600">Terms of Service content will be added here.</p>
      </div>
    </div>
  );
}
