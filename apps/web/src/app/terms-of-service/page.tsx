  ...
  return (
    <div className="min-h-screen w-full relative bg-white">
      ...
      <div className="w-full max-w-4xl mx-auto px-4 pt-16">
        <h1 className="text-3xl font-gloucester mb-8" {...buildTypographyDataAttributes({ area: "user-frontend", pageKey: "legal", instanceKey: "document", role: "heading" })}>Terms of Service</h1>
        <p className="font-hamburg text-gray-600" {...buildTypographyDataAttributes({ area: "user-frontend", pageKey: "legal", instanceKey: "document", role: "body" })}>Terms of Service content will be added here.</p>
      </div>
    </div>
  );
}
