...
export default async function AdminSocialAccountProfileCollaboratorsTagsPage({ params }: PageProps) {
  ...
  if (rawHandle !== handle) {
    redirect(buildSocialAccountProfileUrl({ platform, handle, tab: "collaborators-tags" }));
  }
  return (
