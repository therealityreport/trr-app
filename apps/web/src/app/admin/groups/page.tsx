      ...
      <div className="min-h-screen bg-zinc-50">
        <header className="border-b border-zinc-200 bg-white px-6 py-6">
          <div className="mx-auto flex max-w-6xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-500">Admin / Groups</p>
        ...
        <main className="mx-auto max-w-6xl px-6 py-8">
          <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-2 text-2xl font-bold text-zinc-900">Groups</h2>
            <p className="mt-2 text-sm text-zinc-600">
              This container is a placeholder for future admin tooling (group definitions, membership, and targeting).
            </p>
          </section>
        </main>
      </div>
