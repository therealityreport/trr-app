...
const GAME = ADMIN_GAME_MAP.bravodle;

export default function AdminBravodlePage() {
      ...
      <div className="min-h-screen bg-zinc-50">
        ...
        <main className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-8">
          <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-1 text-xl font-bold text-zinc-900">Open Bravodle surfaces</h2>
          ...
          <GameProblemReports gameKey="bravodle" />
        </main>
      </div>
    </ClientOnly>
  );
