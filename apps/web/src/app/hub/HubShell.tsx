  ...
  return (
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto w-full max-w-6xl px-4 pb-12 pt-6 md:px-6 lg:px-8">
        <header className="mb-8 flex w-full flex-col gap-4 border-b border-black px-2 pb-4 sm:h-20 sm:flex-row sm:items-center sm:justify-between sm:px-3 sm:pb-0">
          <div className="flex w-full items-center justify-start sm:flex-1">
            <button
              type="button"
              ...
              onClick={openMenu}
              className="rounded-full p-2 text-zinc-900 transition hover:bg-zinc-100 sm:p-2.5"
            >
              <svg className="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex w-full items-center justify-end gap-2 sm:flex-1 sm:gap-3">
            {user && (
              <>
                <button
                  type="button"
                  ...
                  className="rounded-full p-2 text-zinc-900 transition hover:bg-zinc-100 sm:p-2.5"
                >
                  <svg className="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative" ref={settingsMenuRef}>
                  ...
                  >
                    <svg className="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
