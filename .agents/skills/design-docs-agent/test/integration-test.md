...
grep -c "brand-nyt" apps/web/src/lib/admin/design-docs-config.ts

# Verify component file exists
ls apps/web/src/components/admin/design-docs/sections/BrandNYTSection.tsx

# Verify chart data constants were generated
grep -c "DATA" apps/web/src/components/admin/design-docs/chart-data.ts

# Count skill files (expect 8)
ls .agents/skills/design-docs-agent/*/SKILL.md | wc -l
```
